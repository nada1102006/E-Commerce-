            ...
            <article>
                <div className="relative h-56 overflow-hidden">
                    ...
                    <button
                        ...
                        className={`absolute bottom-4 right-4 rounded-full p-2.5 shadow-lg transition ${isDarkMode ? 'bg-slate-900/80' : 'bg-white/90'} ${isFavorite ? 'text-danger-500' : 'text-slate-700'}`}
                    >
                        <FiHeart
                            size={16}
