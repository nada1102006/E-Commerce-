...
<div className="rounded-3xl bg-gradient-to-r from-slate-700 via-slate-600 to-indigo-700 px-6 py-12 text-center sm:px-12 shadow-2xl">          <FaEnvelope className="mx-auto mb-4 text-3xl text-white/90" />
