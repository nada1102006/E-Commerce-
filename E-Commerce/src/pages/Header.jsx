    ...
    <header className="fixed top-3 md:top-5 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-7xl bg-[#070B1A]/95 backdrop-blur-lg rounded-2xl lg:rounded-full shadow-2xl border border-white/10">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          {isLogin ? (
            <button
              ...
              className="justify-center items-center gap-1 rounded-full border border-slate-200 bg-slate-50/90 px-3 py-2 text-slate-600 shadow-sm transition-colors hover:bg-white hover:text-indigo-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800 hidden md:flex"
            >
      ...
      >
        <div className="px-5 border-t border-gray-700">
          ...
          {/* Mobile Profile/Login Button with username */}
          {isLogin ? (
            <button
              onClick={() => {
                setMenuOpen(false);
              ...
              className="w-full mt-5 flex items-center justify-center gap-3 bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-xl font-semibold transition-all duration-300 hover:shadow-lg"
            >
